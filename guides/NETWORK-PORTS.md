...
| **sert-umbrel-pool-poolui** | 8560 | **Моя панель (Pool Dashboard)** — poolui: статистика, графики, кошелёк |
...
- **Pool Dashboard (ваша панель poolui):** `sert-umbrel-pool-poolui_web_1` (порт 80)
