...
Список монет на странице **Pool Configuration** (приложение Pool Config, порт 8562) берётся из файла **coins.json** на сервере Umbrel.
...
4. Откройте http://ВАШ-IP:8562 (Pool Config) → Pool Configuration и нажмите **Refresh Master Coin List**. Подробно: **guides/COINS-JSON-SETUP.md**.
