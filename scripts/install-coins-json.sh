...
docker restart sert-umbrel-pool-miningcore-webui_web_1 2>/dev/null || true
echo "Done. Open http://YOUR-IP:8562 (ваша панель), then 8563 for Setup DB / Generate Config. SETUP-FULL.md in repo."
