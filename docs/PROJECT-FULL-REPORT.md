...
*Документ составлен по состоянию проекта на момент полной настройки панели (графики, воркеры, компактность, BTC первый, обновление статистики, Share Sum, Found, иконки, документация).*
