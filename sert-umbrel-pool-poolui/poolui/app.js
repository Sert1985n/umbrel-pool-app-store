...
/** MiningCore API returns long status strings (e.g. "Block maturation requires new blocks in the network"). Map to short display. */
function fmtBlockStatus(s){
  ...
  if(t.length > 24) return 'Pending'; // long API message
  return s;
}
